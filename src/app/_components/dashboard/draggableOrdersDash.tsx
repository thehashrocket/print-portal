...
const DraggableDash = ({ initialOrders }) => {
        ...
        <div className="p-5 bg-gray-800 text-white min-h-screen">
            {Object.keys(ordersByStatus).map(status => (
                <div key={status}
                    ...
                    className="p-4 mb-4 border border-gray-600 rounded-lg shadow bg-gray-700"
                    style={{ minHeight: '50px' }}> {/* Ensure droppable areas are visible */}
