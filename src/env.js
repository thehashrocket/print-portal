...
export const env = createEnv({
  ...
  server: {
    ...
    SENDGRID_ORDER_STATUS_TEMPLATE_ID: z.string(),
    SENDGRID_ORDER_TEMPLATE_ID: z.string(),
 ...
 client: {
  ...
  runtimeEnv: {
    ...
    SENDGRID_MAGIC_LINK_TEMPLATE_ID: process.env.SENDGRID_MAGIC_LINK_TEMPLATE_ID,
    SENDGRID_ORDER_STATUS_TEMPLATE_ID: process.env.SENDGRID_ORDER_STATUS_TEMPLATE_ID,
    SENDGRID_ORDER_TEMPLATE_ID: process.env.SENDGRID_ORDER_TEMPLATE_ID,
