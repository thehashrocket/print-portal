...
import { productTypeRouter } from "./routers/shared/productTypes/productType";
...
import { orderVersionsRouter } from "./routers/orderVersions";
/**
...
export const appRouter = createTRPCRouter({
  ...
  orderVersions: orderVersionsRouter,
