...
function MyComponent() {
  const { data, isLoading } = api.hello.useQuery(z.object({
  text: "example"
}));
...
async function MyServerComponent() {
  const data = await api.hello.query(z.object({
  text: "example"
}));
...
function MyComponent() {
  const { data, isLoading } = api.getLatest.useQuery({});
...
async function MyServerComponent() {
  const data = await api.getLatest.query({});
...
function MyComponent() {
  const { data, isLoading } = api.getSecretMessage.useQuery({});
...
async function MyServerComponent() {
  const data = await api.getSecretMessage.query({});
